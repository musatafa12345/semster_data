...
int main()
{
	...
	cout<<"Enter password = ";
	cin>>password;
	///copy_password == password; error be cause array can not copy of array////
	strcpy(copy_password,password);
	cout<<"Your password is = "<<password<<endl;
	cout<<"copy_password is = "<<copy_password<<endl;
    int length_of_password=strlen(copy_password);
    cout<<length_of_password<<endl;
    system("cls");//clear screen/////hide word//////////
    for(int i=0;i<length_of_password;i++)
    {
    	copy_password[i]='*';
	}
	cout<<"Your password is = "<<length_of_password<<endl;
	//////////////////////////////////////////////////////////////////////
	cout<<"Enter the character to guess password"<<endl;
